...
<AccordionGroup>
  ...
  <Accordion title="Get light monogram fallback for non-existent logo">
    ...
    ```md Request
    https://img.logokit.com/crypto/INVALID?fallback=monogram-light&token=<publishable-api-token>
    ```
    
    This will return a light monogram image generated from the first three letters of the cryptocurrency symbol with a light background, perfect for light-themed interfaces.
    
     <Frame>
      <img src="/images/INV.png" alt="INV logo" />
    </Frame>
  </Accordion>
