...
By default, logo images are returned in PNG format, and the size is 32x32 pixels for free plan users and 128x128 pixels for paid plan users.
...
```md Request
https://img.logokit.com/<domain>?token=<publishable-api-token>
```

### Parameters

<ParamField path="domain" type="string" required>
  The domain for which you want to retrieve the logo. For example, `apple.com`.
</ParamField>
...
<ParamField path="fallback" default="monogram" type="string">
